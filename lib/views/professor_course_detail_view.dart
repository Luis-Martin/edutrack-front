...
import 'professor_course_students_view.dart';
import 'professor_course_grades_view.dart';
import 'professor_course_attendance_view.dart';

class ProfessorCourseDetailView extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Información General',
              style: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFFF07613)),
            ),
            ...
            Text(
              'Acciones',
              style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFFF07613)),
            ),
            const SizedBox(height: 12),
            Row(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ProfessorCourseStudentsView(courseData: courseData),
                        ),
                      );
                    },
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ProfessorCourseGradesView(courseData: courseData),
                        ),
                      );
                    },
                    icon: const Icon(Icons.grade),
                    label: const Text('Colocar Notas'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFFF07613),
                      foregroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(vertical: 14),
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ProfessorCourseAttendanceView(courseData: courseData),
                        ),
                      );
                    },
                    icon: const Icon(Icons.check_circle),
                    label: const Text('Colocar Asistencia'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFFF07613),
                      foregroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(vertical: 14),
